...
class BillDetailMixin(BaseHandler):
    def _bill_batch_edit(self, d):
        ...
        <div class="col-12"><button class="btn btn-primary">预览批量修正</button> <a href="/bills" class="btn btn-outline-secondary">取消</a></div>
        </form>
    ...
    def _bill_batch_edit_preview(self, d):
        ...
        <a href="/bills" class="btn btn-outline-secondary">取消</a></form>
        ''', 'bills'))
    ...
    def _bill_batch_edit_apply(self, d):
        ...
        <a class="btn btn-outline-primary" href="/bills">返回账单列表</a>
        ''', 'bills'))
