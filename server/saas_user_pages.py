...
.shell{{max-width:1180px;margin:0 auto;padding:32px 24px 48px}}.hero{{display:flex;justify-content:space-between;gap:18px;align-items:flex-end;margin-bottom:22px}}
