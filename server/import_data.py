...
class ImportMixin(ImportPreviewMixin, ImportFeeMappingMixin, ImportViewMixin, BaseHandler):
    ...
    COLUMN_MAP = {
        ...
        '业主':'owner_name','业主姓名':'owner_name','owner_name':'owner_name','姓名':'owner_name','name':'owner_name','客户':'owner_name','租户':'owner_name','租户姓名':'tenant_name','租户电话':'tenant_phone','承租人电话':'tenant_phone','租户手机号':'tenant_phone','租户身份证号':'tenant_id_card','承租人身份证号':'tenant_id_card',
