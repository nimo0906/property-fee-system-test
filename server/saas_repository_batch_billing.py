...
def attach_batch_billing_repository_methods(cls):
    ...
    def batch_generate_bills(self, tenant_id, project_id, fee_type_id, period, service_start, service_end, category='', building='', unit='', actor_user_id=None, use_payment_cycle=False):
