...
def handle_get(handler):
    ...
    elif p == '/commercial_license': return handler._license_plan()
    elif p == '/license_status': return handler._license_status()
    elif p == '/first_run_guide': return handler._first_run_guide()
    elif p == '/cloud_deployment_plan': return handler._cloud_deployment_plan()
