...
class CloudSecurityPageMixin(BaseHandler):
    def _cloud_security_baseline(self):
        ...
        self._html(self._page("云端技术备查安全检查", """
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive"><table class="table table-sm align-middle">
              <thead><tr><th>检查项</th><th>当前底座</th><th>云端上线要求</th></tr></thead>
              <tbody>
    ...
    def _cloud_go_live_checklist(self):
        if not self._delivery_allowed():
            return self._redirect("/?flash=无权限访问该页面")
        self._html(self._page("云端技术备查检查清单", """
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive"><table class="table table-sm align-middle">
              <thead><tr><th>门槛</th><th>检查口径</th><th>入口</th></tr></thead>
              <tbody>
    ...
    def _cloud_deployment_drill(self):
        if not self._delivery_allowed():
            return self._redirect("/?flash=无权限访问该页面")
        self._html(self._page("云端技术备查执行单", """
        <div class="alert alert-primary border-primary">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive"><table class="table table-sm align-middle">
              <thead><tr><th>步骤</th><th>必须执行</th><th>留存证据</th><th>入口</th></tr></thead>
              <tbody>
    ...
    def _delivery_b_phase_review(self):
        if not self._delivery_allowed():
            return self._redirect("/?flash=无权限访问该页面")
        self._html(self._page("技术备查完成审查", """
