...
TEMPLATES = {
    'basic': {
        ...
        'rows': [['默认项目','示例项目','商场','1F-101',1,'商户',88.5,4.8,'非居民','甲商贸','13900000000','','李四','13800000001','','2026-01-01','2026-12-31','季付','某某便利店','餐饮','基础资料模板，不填写历史收款金额'], ['默认项目','B座','B座','902',9,'居民',95.2,'','非居民','王五','13800000000','','','','','2026-01-01','2026-12-31','月付','','','住宅示例，仅填写基础资料']],
    ...
    'b_tower_contracts': {
        ...
        'rows': [['B座','B座','902','李四','13800000001',95.2,1.9,'月付','2026-01-01','2026-12-31','非居民','默认只更新已有 B座收费对象']],
