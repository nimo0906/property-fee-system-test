...
FIELD_ALIASES = {
    ...
    "category": ("category", "类型", "类别", "对象类型", "房屋类别", "房间类型", "业态/商户类别"),
    "area": ("area", "面积", "面积㎡", "建筑面积", "平方"),
    "owner_name": ("owner_name", "业主姓名", "业主", "客户名称", "商户名称"),
    "owner_phone": ("owner_phone", "联系电话", "手机号", "业主电话", "业主电话", "电话"),
    "owner_type": ("owner_type", "业主类型", "客户类型"),
    "unit_price_override": ("unit_price_override", "独立单价", "覆盖单价", "商户单价", "物业费单价", "商业物业费单价", "单价", "custom_rate"),
    "floor": ("floor", "楼层", "层数"),
    "shop_name": ("shop_name", "店名", "商户店名", "铺位名称", "店铺名称", "店铺", "商铺名称"),
    "tenant_name": ("tenant_name", "租户", "租户姓名", "承租人", "承租方"),
    "tenant_phone": ("tenant_phone", "租户电话", "承租人电话", "承租电话", "租户手机号"),
