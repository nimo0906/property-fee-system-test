...
def db_init():
    ...
    """
    c.executescript(SQL)
    for col in ['contract_start','contract_end','id_card','id_card_front','id_card_back','business_type','water_rate_type','shop_name','tenant_name','tenant_id_card','payment_cycle']:
