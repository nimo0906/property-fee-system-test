...
<section class="card" style="margin-top:18px"><div class="card-h">交付步骤</div><div class="card-b"><table><thead><tr><th>序号</th><th>步骤</th><th>验收口径</th></tr></thead><tbody>{rows}</tbody></table></div></section>'''
