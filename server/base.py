...
class BaseHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        elif p == '/invoice_requests': return self._invoice_requests(q)
    ...
    def do_POST(self):
        ...
        elif (m := re.match(r'^/invoice_requests/([^/]+)/status$', p)): return self._invoice_request_status_post(m.group(1), d)
