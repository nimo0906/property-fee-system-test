...
class TestIntegration13(IntegrationTestBase):
    ...
    def test_merchant_contract_archive_groups_b_tower_and_commercial_contracts(self):
        ...
        self.assertNotIn('page-proposal-hero', page)
        ...
        status, property_page = http_get('/merchant_contracts?contract_scope=property', self.cookie, TEST_PORT)
        self.assertEqual(status, 200)
        self.assertIn('contract-scope-tab property active', property_page)
        self.assertIn('HT-B-GROUP-001', property_page)
        self.assertNotIn('HT-M-GROUP-001', property_page)
        self.assertIn('name="contract_scope" value="property"', property_page)

        status, commercial_page = http_get('/merchant_contracts?contract_scope=commercial', self.cookie, TEST_PORT)
        self.assertEqual(status, 200)
        self.assertIn('contract-scope-tab commercial active', commercial_page)
        self.assertIn('HT-M-GROUP-001', commercial_page)
        self.assertNotIn('HT-B-GROUP-001', commercial_page)
        self.assertIn('name="contract_scope" value="commercial"', commercial_page)
