...
class TestCloudMigration(unittest.TestCase):
    ...
    def test_migration_summary_reports_core_counts_and_money(self):
        ...
        self.assertEqual(summary["scope"]["b_tower_rooms"], 1)
        self.assertEqual(summary["scope"]["mall_rooms"], 1)
        self.assertEqual(summary["reconciliation"]["b_tower_bill_total"], 300.0)
        self.assertEqual(summary["reconciliation"]["mall_bill_total"], 500.0)
