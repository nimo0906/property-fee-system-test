...
class TestBasicImport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.db.execute(
            ...
            "floor INTEGER, category TEXT, area REAL, owner_id INTEGER, contract_start TEXT, contract_end TEXT, business_type TEXT, tenant_name TEXT, tenant_phone TEXT, tenant_id_card TEXT, notes TEXT)"
        )
    ...
    def test_imports_room_owner_contract_and_notes_without_money(self):
        headers = ['类别', '房号', '业主姓名', '面积㎡', '联系电话', '租户姓名', '租户电话', '租户身份证号', '店铺名称', '业态', '合同缴租期']
        col_map = {
            'category': 0, 'room_number': 1, 'owner_name': 2, 'area': 3,
            'owner_phone': 4, 'tenant_name': 5, 'tenant_phone': 6, 'tenant_id_card': 7, 'shop_name': 8,
            'business_type': 9, 'contract_period': 10,
        }
        rows = [['商户', 'B座一楼大厅', '东大置业', '18.9', '18291415177', '程西琴', '13800138888', '610101199003033456', '烟酒小商店', '便利店', '2024.10.1-2027.9.30']]
        ...
        self.assertEqual(room['tenant_phone'], '13800138888')
