...
class TestIntegration27(IntegrationTestBase):
    def test_reports_reconciliation_sections_and_export_links(self):
        ...
        self.assertIn('账单状态', html)
        self.assertIn('已缴', html)
        self.assertIn('部分', html)
        self.assertIn('未缴', html)
        self.assertIn('未收合计', html)
    ...
    def test_reports_export_actions_are_grouped_by_business_purpose(self):
        ...
        self.assertIn('class="dropdown-header">对账与打印', html)
        self.assertIn('class="dropdown-header">客户维度', html)
        self.assertIn('class="dropdown-header">欠费分析', html)
    ...
    def test_reports_can_select_multi_month_billing_period(self):
        ...
        self.assertIn('应收合计</div><strong class="money">¥400.0</strong>', inner_html)
        self.assertIn('已收合计</div><strong class="money money-paid">¥150.0</strong>', inner_html)
