...
CHECKS = [
    ...
    "scripts/saas_module6_batch_billing_gate.py",
    "scripts/saas_module7_payment_arrears_gate.py",
    "scripts/saas_module8_import_review_gate.py",
    "scripts/saas_module9_report_export_print_gate.py",
    "scripts/saas_module11_meter_reading_gate.py",
    "scripts/saas_module13_merchant_contract_gate.py",
    "scripts/saas_module10_cloud_ui_replica_gate.py",
