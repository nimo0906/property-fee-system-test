...
{"kind":"property-saas-backup","created_at":"$ts","database":"db/property_saas.sql","tenant_files":"tenant-files/customer_files.tar.gz","system_files":"system-files/system_files.tar.gz","acceptance_records":"first_tenant_acceptance/records.json","production_acceptance_signoffs":"production_acceptance_signoffs/history.json","production_acceptance_result":"saas-production-acceptance-result.md","checksums":"checksums.sha256"}
JSON
