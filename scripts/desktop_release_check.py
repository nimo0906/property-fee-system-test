...
CHECKS = [
    ...
    ('Windows server launcher', ROOT / 'start_windows_server.bat'),
    ('Windows background task installer', ROOT / 'install_windows_background_task.bat'),
    ('Windows background task status checker', ROOT / 'status_windows_background_task.bat'),
    ('Windows background task uninstaller', ROOT / 'uninstall_windows_background_task.bat'),
    ('Windows server no-console guide', ROOT / 'Windows服务器无黑框运行说明.md'),
